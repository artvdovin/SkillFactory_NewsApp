...
def my_job():
    ...
    subscriptions = set(Subscription.objects.filter(category__name__in=categories).values_list('user__email', flat=True))
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            ...
            trigger=CronTrigger(day_of_week="fri", hour="18", minute="00",second="00"),  # Every 10 seconds
